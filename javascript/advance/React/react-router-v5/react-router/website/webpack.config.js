...
module.exports = {
  ...
  module: {
    rules: [
      ...
      //   exclude: /node_modules/,
      //   include: [
      //     path.resolve(__dirname, "../packages/react-router/modules"),
      //     path.resolve(__dirname, "../packages/react-router-dom/modules"),
      //     path.resolve(__dirname, "./modules/index.js"),
      //     path.resolve(__dirname, "./modules/components/App.js"),
      //   ],
      //   use: {
      //     loader: "babel-loader"
      //   }
