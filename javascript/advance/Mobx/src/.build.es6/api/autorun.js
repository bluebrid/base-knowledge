...
export function autorun(view, opts = EMPTY_OBJECT) {
    ...
    let reaction;
    if (runSync) {
        // 同步 .build.es6\core\reaction.js, 每个autorun 都会创建一个reaction 对象
        //  Reaction. schedule 方法会将每个reaction都保存在globalState.pendingReactions.push(this);
        // .build.es6\core\derivation.js  中 trackDerivedFunction 方法，会将当前的 reaction 保存在 全局的trackingDerivation上:
