...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		console.log('    1.7.1.============================> [默认插件] EntryOptionPlugin')
		new EntryOptionPlugin().apply(compiler);
		console.log('    1.7.2.============================> [生命钩子]执行entryOption 生命钩子, 在EntryOptionPlugin插件中注册了entryOption钩子')
		...
		console.log('1.7.5.============================> [生命钩子]执行entryOption 生命钩子afterPlugins,所有的Plugin 都挂载到了compiler 上面了')
		...
		console.log('1.7.5.============================> [生命钩子]执行entryOption 生命钩子afterResolvers')
