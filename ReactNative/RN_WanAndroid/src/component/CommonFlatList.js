    ...
    return (
      <View style={styles.container}>
        <FlatList
          ...
          refreshControl={ 
            <RefreshControl // 这一组件可以用在ScrollView或FlatList内部，为其添加下拉刷新的功能。当ScrollView处于竖直方向的起点位置（scrollY: 0），此时下拉会触发一个onRefresh事件。
          ...
          {...this.props} // 其余的属性，如renderItem
        />
        {this.state.isShowTop ? ( // 返回最上面
