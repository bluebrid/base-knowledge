...
// ISuspensionBean 是azlistview 中定义的 https://github.com/flutterchina/azlistview/blob/master/lib/src/az_common.dart
...
class _CitySelectPageState extends State<CitySelectPage> {
  ...
  void loadData() async {
    //加载城市列表 ： 每个Flutter应用程序都有一个rootBundle对象， 可以轻松访问主资源包。可以直接使用package:flutter/services.dart中全局静态的rootBundle对象来加载asset。
  ...
  void _handleList(List<CityInfo> list) {
    ...
    // SuspensionUtil 也是azlistviw 中定义的类
