...
import 'package:flutter_wanandroid/common/component_index.dart' show Ids, LogUtil, MyAppBar, Utils, NavigatorUtil, IntlUtil ;
  ...
  Widget build(BuildContext context) {
    ...
    return new DefaultTabController(
        ...
        child: new Scaffold(
          ...
          body: new TabBarViewLayout(), // 渲染tab的body
          drawer: new Drawer(// 左侧的抽屉菜单
